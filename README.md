...
The store is like the heart of the app, it holds on to the state tree
Actions are payloads of data that get send to the store
Reducers are specify how the state changes based on the actions
...
Thunk allows us to write action creators that return functions instead of a regular action  
